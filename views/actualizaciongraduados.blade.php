...
<head>
    ...
    <title>Encuesta de graduados - Universidad de Ibagué</title>
...
<body>
    ...
    <script type="module">
        ...
        const encuestaSections = [
            ...
            },
            {
                ...
                fields: [
                    ...
                    { key: 'anio_graduacion_master', label: 'Año de graduación de Especialización o maestría', type: 'number', description: 'Año en que obtuviste tu título de especialización o maestría', required: false, placeholder: 'Ej: 2020' },
                    {
                        key: 'programa',
            ...
            },
            {
                ...
                icon: '',
                fields: [
                    { key: 'estado_laboral', label: '¿Cuál es tu situación laboral actual?', type: 'radio', options: ['Empleado', 'Desempleado', 'Independiente', 'Empresario', 'Estudiante de postgrado'], required: true }
                ]
            },
            {
                ...
                fields: [
                    {
                        key: 'metodo_empleo',
                        label: '¿Por cuales metodos ha obtenido sus empleos?',
                        type: 'checkbox',
                        options: ['Bolsa de empleo', 'Contactos', 'Medios de comunicación', 'Intermediación laboral por información de la Universidad de Ibagué', 'No aplica'],
                        required: true,
                    ...
                    {
                        key: 'cargo',
                        label: 'Nombre del cargo que desempeña actualmente o, si es pensionado(a), del último cargo que ocupó ',
                        type: 'text',
                        required: true,
                    ...
                    {
                        key: 'salario',
                        label: 'Rango salarial mensual actual',
                        type: 'radio',
                        options: [
                            'Entre 1 y 2 salarios mínimos',
                            'Entre 2 y 3 salarios mínimos',
                            'Entre 3 y 5 salarios mínimos',
                            'Entre 5 y 8 salarios mínimos',
                            'Entre 8 y 12 salarios mínimos',
                    ...
                    {
                        key: 'nivel laboral',
                        label: 'Seleccione el nivel laboral del empleo actual, o del último empleo si es pensionado(a)',
                        type: 'radio',
                        options: [
                        'Analistas, programadores, desarrolladores, diseñadores, creadores y generadores de contenido',
                        'Consultores, contratistas, independientes',
                        'Docentes, profesores, instructores, formadores',
                        'Fuerza pública, militares',
                        'Jefes, supervisores, líderes de área, coordinadores, sub coordinadores',
                        'Magistrados, jueces, procuradores, fiscales, políticos',
                        'Soporte administrativo y operativo, asesores, ejecutivos comerciales, técnicos',
                        'Auditores, revisores fiscales, interventores',
                        'Directivos, gerentes, directivos docentes, subgerentes, subdirectores'
                        ],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente'
                    },
                    ...
                    {
                        key: 'antiguedad',
                        label: '¿Cuánto tiempo llevas vinculado a tu empleo actual o, si es pensionado(a), en su ultimo empleo?',
                        type: 'radio',
                ...
                fields: [
                    {
                        ...
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'anios_constitucion',
                        label: '¿Hace cuántos años constituyó su empresa?',
                        type: 'radio',
                        options: ['Menos de 1 año', 'De 1 a 5 años', 'De 6 a 10 años', 'Más de 10 años'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'pais_empresa',
                        label: 'País donde está ubicada su empresa',
                        type: 'country',
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'ciudad_empresa',
                        label: 'Ciudad donde está ubicada su empresa',
                        type: 'city',
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empresario'
                    }
            ...
            },
            {
                ...
                fields: [
                    {
                        key: 'reconocimientos',
                        label: '¿Ha recibido algún reconocimiento por su desempeño profesional?',
                        type: 'radio',
                        options: ['Sí', 'No'],
                        required: true
                    },
                    {
                        key: 'detalle_reconocimientos',
                        label: 'Si respondió sí, por favor indique cuáles',
                        type: 'textarea',
                        required: false,
                        placeholder: 'Ej: Premio al mejor empleado del año 2022'
                    }
                ]
            },
            {
                ...
                fields: [
                    {
                        key: 'F4C16P1',
                        label: 'En qué medida considera que el perfil de formación, las competencias adquiridas y las posibilidades que le ha ofrecido su formación han contribuido a su desarrollo profesional y laboral',
                        type: 'radio',
                        options: ['Muy bajo grado', 'Bajo Grado', 'Medianamente', 'Alto grado', 'Muy alto grado'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario' 
                    },
                    {
                        key: 'F4C117P1',
                        label: 'Considera que su desempeño laboral y profesional ha tenido impactos positivos en:',
                        type: 'radio',
                        options: ['El aporte a la solución de problemas de la sociedad', 'El aporte a la ciencia y la academia', 'El aporte a la cultura y el arte', 'Ninguno', 'No aplica'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'F4C17P2',
                        label: 'Si lo desea por favor especifique el aporte mencionado anteriormente',
                        type: 'textarea',
                        required: false,
                        placeholder: 'Ej: He contribuido a la creación de un software que ayuda a personas con discapacidad visual',
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'F5C19P1',
                        label: 'En qué medida considera que las rutas de formación alternativas derivadas de las estrategias de flexibilidad curricular (cursos electivos: Electiva Humanística, movilidad, entre otros) fueron coherentes con sus necesidades e intereses',
                        type: 'radio',
                        options: ['Muy bajo grado', 'Bajo Grado', 'Medianamente', 'Alto grado', 'Muy alto grado', 'no aplica'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'F7C32P1',
                        label: 'En qué medida considera que las acciones de cooperación académica y científica (curso con docente internacional, convenios, estrategias para un segundo idioma, movilidad, entre otros) desarrolladas por el Programa favorecen la interacción entre profesores y estudiantes a nivel nacional e internacional',
                        type: 'radio',
                        options: ['Muy bajo grado', 'Bajo Grado', 'Medianamente', 'Alto grado', 'Muy alto grado'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    ...
                    {
                        key: 'F9C37P1',
                        label: 'En qué medida considera que la infraestructura, espacios y servicios de bienestar (gimnasio, sede deportiva, asesoría psicológica, entre otros) son de calidad y pertinentes',
                        type: 'matrix',
                        rows: ['De calidad', 'Pertinentes'],
                        options: ['Muy bajo grado', 'Bajo grado', 'Medianamente', 'Alto grado', 'Muy alto grado'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'F11C41P1',
                        label: 'En qué medida considera que la participación de los egresados en los órganos colegiados (comité de Programa, consejo de Facultad, Consejo Superior, Consejo de Fundadores, entre otros) ha contribuido al mejoramiento del Programa',
                        type: 'radio',
                        options: ['Muy bajo grado', 'Bajo Grado', 'Medianamente', 'Alto grado', 'Muy alto grado', 'No lo conozco'],
                        required: true,
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'necesidades_capacitacion',
                        label: '¿Cuáles son sus necesidades o espectativas en terminos de capacitación?',
                        type: 'textarea',
                        required: true,
                        placeholder: 'Ej: Me gustaría recibir capacitación en análisis de datos y programación en Python',
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    },
                    {
                        key: 'observaciones',
                        label: 'En caso de observaciones utilice este espacio',
                        type: 'textarea',
                        required: false,
                        placeholder: 'Ej: Me gustaría que la universidad ofreciera más cursos de actualización en mi área de trabajo',
                        showIf: (a) => a.estado_laboral === 'Empleado' || a.estado_laboral === 'Independiente' || a.estado_laboral === 'Empresario'
                    }
                ]
            },
            {
                ...
                fields: [
                    {
                        key: 'recomendacion',
                        label: '¿Recomendaría a la Universidad de Ibagué como una institución de educación superior?',
                        type: 'radio',
                        options: ['Sí', 'No'],
                        required: true
                    }
        ...
        function fieldHtml(field) {
            ...
            if (field.type === 'matrix') {
                const matrixValue = answers[field.key] || {};

                return `
                    <div class="matrix-wrap" data-key="${field.key}">
                        <table class="matrix-table">
                            <thead>
                                <tr>
                                    <th></th>
                                    ${field.options.map(option => `<th>${option}</th>`).join('')}
                                </tr>
                            </thead>
                            <tbody>
                                ${field.rows.map(row => `
                                        ...
                                        ${field.options.map(option => `
                                            <td>
                                                <input type="radio"
                                                    ...
                                                    value="${option}"
                                                    ${matrixValue[row] === option ? 'checked' : ''}
                                                    onchange="setMatrixAnswer('${field.key}', '${row}', this.value)">
                                            </td>
                                        `).join('')}
                                    </tr>
                                `).join('')}
            ...
            return `<input class="input-field" type="${field.type}" id="field_${field.key}" value="${value}" placeholder="${placeholder}" autocomplete="off" ${numericAttributes} ${readOnly} oninput="onInputChange('${field.key}')">`;
        }
        ...
        function setMatrixAnswer(key, row, value) {
            answers[key] = { ...(answers[key] || {}), [row]: value };
            const field = encuestaSections
                .flatMap(section => section.fields)
                .find(item => item.key === key);
            const fieldEl = document.querySelector(`.form-field[data-key="${key}"]`);
            if (fieldEl && field && !isFieldEmpty(field)) {
                fieldEl.classList.remove('has-error');
            }
            updateNextButton();
        }
        ...
        function onCountryChange(countryKey) {
            ...
            const countrySelect = document.getElementById(`field_${countryKey}`);
            const citySelect = document.getElementById(`field_${cityKey}`);
            const stateSelect = stateKey ? document.getElementById(`field_${stateKey}`) : null;
        ...
        function saveCurrentSectionAnswers() {
            ...
            section.fields.forEach(field => {
                ...
                if (field.type === 'country') {
                    const countrySelect = document.getElementById(`field_${field.key}`);
        ...
        window.setMatrixAnswer = setMatrixAnswer;
