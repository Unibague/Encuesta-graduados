...
<head>
    ...
    <title>Encuesta de egresados - Universidad de Ibagué</title>
    ...
    <style>
        ...
        * { box-sizing: border-box; margin: 0; padding: 0; }
        ...
        .field-number {
            ...
            font-size: 12px;
            flex-shrink: 0;
            box-shadow: 0 4px 10px -3px rgba(252,189,0,0.45);
        }
    ...
    <div class="encuesta-shell">
        <div class="encuesta-container">
            ...
            <div class="encuesta-intro">
                <h1>Actualización de datos egresados</h1>
            ...
            <div class="survey-card">
                ...
                <div id="summaryView" style="display: none;">
                    ...
                    <div class="nav-row">
                        ...
                        <button type="button" class="btn btn-success" onclick="submitSurvey()">Enviar encuesta ✓</button>
                    </div>
                </div>
