@component('templates.main')
    ...
    @slot('header')
        ...
        :root {
            --primary:#FCBD00; --primary-dark:#D9A200; --primary-light:#FFF8E0;
            ...
            --shadow:0 20px 45px -20px rgba(252,189,0,.35);
        }
        .migrated-page {
            min-height:100vh; padding:40px 16px 60px;
            background:radial-gradient(circle at 12% 8%,rgba(252,189,0,.18),transparent 40%),
        ...
        .migrated-card {
            ...
            border:1px solid rgba(252,189,0,.12); border-radius:26px;
            padding:28px; box-shadow:var(--shadow);
        }
        .migrated-card:before {
            content:''; position:absolute; top:-60px; right:-60px; width:160px; height:160px;
            border-radius:50%; background:radial-gradient(circle,rgba(252,189,0,.12),transparent 70%);
            pointer-events:none;
        }
        .migrated-search {
        ...
        .migrated-search input:focus {
            ...
            box-shadow:0 0 0 4px rgba(252,189,0,.18);
        }
        .migrated-search button {
            flex-shrink:0; border:none; border-radius:13px;
            background:linear-gradient(135deg,var(--primary),var(--primary-dark));
            color:#1f2333; padding:13px 24px; font-size:14px; font-weight:700;
            font-family:inherit; cursor:pointer; box-shadow:0 8px 18px -8px rgba(252,189,0,.5);
        ...
        .migrated-table thead th {
            ...
            border:0!important; border-bottom:2px solid rgba(252,189,0,.25)!important;
        ...
        .migrated-pagination .page-item.active .page-link {
            ...
            color:#1f2333; box-shadow:0 6px 14px -6px rgba(252,189,0,.5);
        }
